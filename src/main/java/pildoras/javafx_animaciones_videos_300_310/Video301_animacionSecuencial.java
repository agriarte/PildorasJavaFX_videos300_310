...
/**
 * JavaFX Video301_animacion secuencial
 */
public class Video301_animacionSecuencial extends Application {
    ...
    public void start(Stage stage) {
        ...
        // Arrancar la animación secuencial. Cuando acaba la primera, empieza la sengunda
        SequentialTransition pt = new SequentialTransition(t,t2);
        pt.play();
